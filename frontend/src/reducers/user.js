...
export const updateReducer = createReducer(
    {},
    {
        ...
        ADD_EXPERIENCE_REQUEST: (state) => {
            state.loading = true;
        },
        ADD_EXPERIENCE_SUCCESS: (state, action) => {
            state.loading = false;
            state.message = action.payload;
        },
        ADD_EXPERIENCE_FAILURE: (state, action) => {
            state.loading = false;
            state.error = action.payload;
        },

        DELETE_EXPERIENCE_REQUEST: (state) => {
            state.loading = true;
        },
        ...
        ADD_LANGUAGE_REQUEST: (state) => {
            state.loading = true;
        },
        ADD_LANGUAGE_SUCCESS: (state, action) => {
            state.loading = false;
            state.message = action.payload;
        },
        ADD_LANGUAGE_FAILURE: (state, action) => {
            state.loading = false;
            state.error = action.payload;
        },
        ...
        DELETE_LANGUAGE_SUCCESS: (state, action) => {
            state.loading = false;
            state.message = action.payload;
        },
        DELETE_LANGUAGE_FAILURE: (state, action) => {
            state.loading = false;
            state.error = action.payload;
        },
