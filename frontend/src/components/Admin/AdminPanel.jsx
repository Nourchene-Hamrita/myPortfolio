...
const AdminPanel = () => {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        dispatch(updateUser(name, address, phone, email, password, skills, about, interest));

        console.log(name, address, phone, email, password, skills, about, interest);
    };
                    ...
                    <div className="adminPanelAbout">
                        <fieldset>
                            ...
                            <input
                                ...
                                value={interest.title1}
                                onChange={(e) => setInterest({ ...interest, title1: e.target.value })}
                                className="adminPanelInputs"
                            />
                            <input
                                type="text"
                                placeholder="Interest 2"
                                value={interest.title2}
                                onChange={(e) => setInterest({ ...interest, title2: e.target.value })}
                                className="adminPanelInputs"
                            />
                            <input
                                type="text"
                                placeholder="Interest 3 "
                                value={interest.title3}
                                onChange={(e) => setInterest({ ...interest, title3: e.target.value })}
                                className="adminPanelInputs"
                            />
                        </fieldset>
                    </div>
